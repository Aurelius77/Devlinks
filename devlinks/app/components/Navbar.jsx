            ...
            {routes.map((route) => {
              ...
              return (
                <Link
                  key={route.link}
                  href={route.link}
                  className={`flex items-center gap-2 px-3.5 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 ${
                    isActive
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {appTheme === 'dark' ? (
                ...
                <svg width="16" height="16" className="w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
